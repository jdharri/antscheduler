 ...
 */
package antscheduler.jpacontrollers;

import antscheduler.exceptions.NonexistentEntityException;
import antscheduler.exceptions.PreexistingEntityException;
...
public class AppointmentJpaController implements Serializable {
    ...
    public void create(Appointment appointment) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findAppointment(appointment.getAppointmentId()) != null) {
                throw new PreexistingEntityException("Appointment " + appointment +
                        " already exists.", ex);
            }
            throw ex;
        } finally {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findAppointment(id) == null) {
                    throw new NonexistentEntityException("The appointment with id " + id +
                            " no longer exists.");
                }
            }
            throw ex;
